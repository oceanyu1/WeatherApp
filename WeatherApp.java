...
// retrieve weather data from API - this backend will fetch latest weather
// from external api and return it. GUI will display it to user
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName) {
        ...
        try {
            ...
            // so we need ot get the index of our current hour
    ...
    // retrieves geographical coordinates for given location name
    public static JSONArray getLocationData(String locationName) {
        ...
        try {
            ...
            // check response status (200 means good)
    ...
    public static String getCurrentTime() {
        ...
        // format date to be 2024-09-02T00:00 (this is how it is read in the API)
